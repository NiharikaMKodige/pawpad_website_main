...
function TopNav({ route, onBook, onOpenCart }) {
  ...
  }, /* @__PURE__ */ React.createElement(CartIcon, { size: 16 }), " View Cart (", cartCount, ")"), /* @__PURE__ */ React.createElement("button", {
